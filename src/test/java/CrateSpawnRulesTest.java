...
public class CrateSpawnRulesTest {
    ...
    public void setUp() {
        ...
        // Simuliamo una griglia 12x12 calpestabile usando lo ZERO!
        for(int r = 0; r < 12; r++) {
            for(int c = 0; c < 12; c++) {
                map.setTile(r, c, 0); 
            }
    ...
    public void testMinimumSpawnDistance() {
        // Forziamo la creazione di due casse consecutive
        map.spawnRandomCrate();
        map.spawnRandomCrate();

        // Verifichiamo che ci siano esattamente 2 casse
