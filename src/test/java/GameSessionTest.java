...
public class GameSessionTest {
    ...
    public void testRandomCoinToss() {
        ...
        // Il risultato deve essere per forza il Giocatore 1 o il Giocatore 2
    ...
    public void testAutomaticRoleCoupling_P1ChoosesSurvivor() {
        // Simuliamo che la moneta l'abbia vinta il P1
        session.setChoosingPlayer(1);

        // Il P1 sceglie il Sopravvissuto
        session.assignRole("SURVIVOR");

        // Il sistema deve assegnare i ruoli in automatico (One-Click & Coupling)
    ...
    public void testAutomaticRoleCoupling_P2ChoosesZombie() {
        // Simuliamo che la moneta l'abbia vinta il P2
        session.setChoosingPlayer(2);

        // Il P2 sceglie lo Zombie
        session.assignRole("ZOMBIE");

        // Il sistema deve assegnare i ruoli in automatico
