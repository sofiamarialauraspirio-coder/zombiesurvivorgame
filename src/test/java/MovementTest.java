...
public class MovementTest {
    ...
    // Verifichiamo che il movimento sia limitato a croce (su, giù, destra, sinistra)
    @Test
    ...
    // Verifichiamo che i muri (Wall) vengano esclusi dalle mosse valide
    @Test
    public void testWallTilesAreExcludedFromMoves() {
        ...
        // Invece di usare "2", chiediamo alla mappa qual è il vero ID del muro (287)
